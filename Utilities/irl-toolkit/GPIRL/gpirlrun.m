...
function [irl_result, st_model] = gpirlrun(algorithm_params,mdp_data,mdp_model,...
...
st_model.gp = gp;
st_model.u = u;
st_model.time = total_time;
st_model.hesseye = elgpirlhessian(struct('hess_approx','eye'),feature_data.splittable,mu_sa,soln,mdp_data,init_s,example_samples,gp,u);
[st_model.hesscov, st_model.hesscov2] = elgpirlhessian(struct('hess_approx','use_cov'),feature_data.splittable,mu_sa,soln,mdp_data,init_s,example_samples,gp,u);
nll = 0;
