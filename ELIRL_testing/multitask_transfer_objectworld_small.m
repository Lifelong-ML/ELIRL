...
save('elirl_objectworld_small.mat','val_elirl',...
    'val_diff_elirl','r_diff_elirl','val_elirl_no_reopt',...
    'val_diff_elirl_no_reopt','r_diff_elirl_no_reopt','avg_val_maxent','err_val_maxent', 'avg_val_diff_maxent',...
