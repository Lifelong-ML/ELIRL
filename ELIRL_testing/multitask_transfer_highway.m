...
% tmp = load('./dumps/maxent_highway2_14-Feb-2017_161920.mat');
...
for j = 1:num_perms
    for i = 1:length(percentages_trained)
        ...
        test_result{i,j} = runmultitasktest_transfer('elirl',algorithm_params,mdp_model,...
...
save('elirl_highway.mat','avg_val_elirl','err_val_elirl',...
    'avg_val_diff_elirl','err_val_diff_elirl','avg_r_diff_elirl',...
    'err_r_diff_elirl','avg_val_maxent','err_val_maxent', 'avg_val_diff_maxent',...
