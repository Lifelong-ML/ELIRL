...
function [mdp_data,r,feature_data,true_feature_map,mdp_params] = objectworld2build(mdp_params, color_placement)
...
mdp_params = objectworld2defaultparams(mdp_params);
...
if ~exist('color_placement', 'var')
    ...
    map1 = color_placement.map1;
    map2 = color_placement.map2;
    c1array = color_placement.c1array;
    c2array = color_placement.c2array;
end
...
[feature_data,true_feature_map,r] = objectworld2features(mdp_params,mdp_data);
