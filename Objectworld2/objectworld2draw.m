...
function objectworld2draw(r,p,g,mdp_params,mdp_data,feature_data,model)
...
for i=1:length(mdp_data.c1array),
    for j=1:length(mdp_data.c1array{i}),
        ...
        % Draw the object.
        rectangle('Position',[x-0.85,y-0.85,0.7,0.7],'Curvature',[1,1],...
            'FaceColor',shapeColors(mdp_params.c1+c2,:),...
            'EdgeColor',shapeColors(c1,:),'LineWidth',4);
    end;
end;
