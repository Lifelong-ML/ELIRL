...
function [feature_data,true_feature_map,r] = objectworld2features(mdp_params,mdp_data)
...
% choose_rew = randsample(mdp_params.c1,choose);
...
for s=1:mdp_data.states,
    ...
    for i=1:mdp_params.c1,
        ...
        if c1dsq(i) < mdp_params.rew_dist
            r(s,:) = r(s,:) + rc(i);
        end
    end;
