...
function [wts, Hessian] = elirlcdmaxentrun(algorithm_params,mdp_data,mdp_model,...
...
% Count features.
features = size(F,2);
% elirlcdinitmodel(algorithm_params,features);
...
fun = @(r)elirlcdmaxentdiscounted(r,F,muE,mu_sa,mdp_data,initD,algorithm_params.laplace_prior);
...
Hessian = elirlcdmaxenthessian(algorithm_params,F,soln,mdp_data,initD,example_samples);
% Clean up.
clear global prev_v;
clear global prev_d;
