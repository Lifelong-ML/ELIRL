function [ irl_result ] = elirlcdtest(algorithm_params,model,mdp_model,mdp_data,...
    feature_data,true_features,taskid, time)
%elirlcdGETRESULT Summary of this function goes here
%   Detailed explanation goes here  
    ...
    r = F * (model.Psi{groupid} * model.L * model.S(:,taskid));
