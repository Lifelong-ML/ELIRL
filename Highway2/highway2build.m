% Construct the highway2 MDP structures.
function [mdp_data,r,feature_data,true_feature_map,mdp_params] = highway2build(mdp_params)

% mdp_params - parameters of the objectworld:
%       seed (0) - initialization for random seed
%       length (32) - length of the highway2
    ...
    for lane=1:mdp_params.lanes,
        for spd=1:mdp_params.speeds,
            ...
            for action=1:5,
                ...
                successors(1,1,action) = highway2coordtostate(ax,nl,as,mdp_params);
            end;
            s = highway2coordtostate(x,lane,spd,mdp_params);
...
[feature_data,true_feature_map,r] = highway2features(mdp_params,mdp_data);
