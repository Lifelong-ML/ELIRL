...
function [s, theta, H, taskSpecific] = elirlencodetask(model, algorithm_params,mdp_data,mdp_model,...
    ...
    if ~isempty(fieldnames(st_model))
        ...
        [theta, H] = elirlmaxentrun(algorithm_params,mdp_data,mdp_model,...
    ...
    [s, taskSpecific] = elirlsparseencode(model, algorithm_params,theta,H);
end
