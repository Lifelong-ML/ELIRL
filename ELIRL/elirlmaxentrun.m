...
function [wts, Hessian] = elirlmaxentrun(algorithm_params,mdp_data,mdp_model,...
...
fun = @(r)elirlmaxentdiscounted(r,F,muE,mu_sa,mdp_data,initD,algorithm_params.laplace_prior);
...
Hessian = elirlmaxenthessian(algorithm_params,F,soln,mdp_data,initD,example_samples);
% Clean up.
clear global prev_v;
clear global prev_d;
